    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="search" placeholder="Cari users..."
                ...
                <table class="min-w-full divide-y divide-gray-100" id="userTable">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">Nama</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                <!-- Edit Button -->
                                <button onclick="openEditModal({{ $user->id }})" class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-1 px-3 rounded-md transition duration-200 border border-gray-200">
            ...
            <div id="modal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center hidden z-50">
                <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 border border-gray-100">
                    <div class="flex justify-between items-center border-b border-gray-100 px-6 py-4">
                        <h2 class="text-xl font-medium text-gray-800" id="modal-title">Tambah User Baru</h2>
                    ...
                    <form id="user-form" action="{{ route('user.store') }}" method="POST" class="px-6 py-4">
                        ...
                        <div class="flex justify-between mt-6 border-t border-gray-100 pt-4">
                            ...
                            <button type="submit"
                                ...
                                <i class="fas fa-plus mr-2"></i><span id="modal-action">Tambah User</span>
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <script>
                ...
                // Fungsi khusus untuk membuka modal Add User
                function openAddModal() {
                    ...
                    document.getElementById('modal-action').textContent = 'Add User';
                    document.getElementById('password').required = true;
                    document.getElementById('modal').classList.remove('hidden');
                }

                // Fungsi khusus untuk membuka modal Edit User
